      ...
      <main className="app-layout">
        <section className="panel">
          ...
          <p className="panel-helper">
            Agrega algunos productos como agua, frituras, snacks, etc. Usa
            categorías para agruparlos por tipo, bebida, sabor, tamaño, marca,
            etc.
          </p>
            ...
            <div className="field-grid">
              ...
              <label className="field">
                ...
                <input
                  ...
                  placeholder="Ej. agua, bebida, sin azúcar"
                />
                <span className="field-hint">
                  Separa las categorías con comas. Se usarán para las búsquedas
                  semánticas.
                </span>
              </label>
            </div>
